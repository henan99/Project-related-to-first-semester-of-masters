...
e(z) = (1 + z)^{v_1 + v_2 z}
 ...
 bins of redshift one will illuminate the number evolution of these objects. 
...
\begin{figure}
    ...
    \caption{Luminosity density for the four different classes of AGNs. The different classes are defined in the title as well as the chosen LF model. The luminosity density is given in units of #/L}
    \label{fig:LD}
\end{figure}

In \ref{fig:LD} one can see the luminosity density for the four different classes of AGNs. The form of the different functions indicative 
of their effect on any 
